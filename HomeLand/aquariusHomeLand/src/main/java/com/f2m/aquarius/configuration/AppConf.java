...
public class AppConf {
	...
	@Bean
	public AquariusLdapParameters getLdapAquariusConf() throws AquariusException {
		AquariusLdapParameters params =  conf.getLdapAquarius();
		if (params == null) {
			throw gutils.throwException(802, "");
		}
		return params;
	...
	@Bean
	public FormsParameters getFormsConf() throws AquariusException {
		FormsParameters params =  conf.getForms();
		if (params == null) {
			throw gutils.throwException(802, "");
		}
		return params;
