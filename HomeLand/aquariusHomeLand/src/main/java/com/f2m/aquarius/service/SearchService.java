...
public class SearchService {
	...
	public ObjectNode executeSearch(String searchString, String executeUser) throws AquariusException {
		...
		if (search != null) {
			...
			List<JsonNode> result = bd.selectColumnsJson(createCustomQuery(selectList, true), createCustomQuery(fromList, true), createCustomQuery(whereList, false), createCustomQuery(orderByList, false), null);
			if (result != null) {
				int count = 0;
