...
public class FormService {
	...
	public int getNumeroControl(String userId) throws AquariusException {
		String where = "data->'formData'->>'template' = 'servicio'";
		List<JsonNode> defTasks = bd.selectJson("formsdata", where, null);
		if (defTasks != null) {
			return defTasks.size();
		} else {
			return 0;
		}
	}
