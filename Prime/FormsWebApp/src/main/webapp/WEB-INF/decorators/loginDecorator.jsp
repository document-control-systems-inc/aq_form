...
<body class="off-canvas-sidebar">
    ...
    <div class="wrapper wrapper-full-page">
    		...
    		<!--  
    			<div class="full-page login-page" data-image="${pageContext.request.contextPath}/assets/img/backgroundLogin.jpg">
        		<div class="content">
    		-->
    		<div class="full-page login-page header-filter" filter-color="black" 
    			style="background-image: url('${pageContext.request.contextPath}/assets/img/backgroundLogin.jpg');background-size: cover; background-position: top center;">
    		<div class="content">
		...
		<footer class="footer">
		    <div class="container-fluid">
		        <p class="copyright pull-right">
		        	<span class="label label-info">Versión ${version}</span>&nbsp;&nbsp;
		            &copy; <script>document.write(new Date().getFullYear())</script> <a href="https://www.f2m.com.mx"> F2M S.A. de C.V. </a>
		        </p>
		    </div>
		</footer>
