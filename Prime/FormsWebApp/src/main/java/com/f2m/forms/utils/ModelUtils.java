...
public class ModelUtils {
	...
	public JsonNode getAccountInfo(HttpSession session) {
		JsonNode userAccountInfo = (JsonNode) session.getAttribute("userInfo");
		logger.debug("Account info: " + userAccountInfo.toString());
		return userAccountInfo;
	}
	
	public JsonNode getProfile(HttpSession session) {
		JsonNode profile = (JsonNode) session.getAttribute("profile");
